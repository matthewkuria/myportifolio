...
export default function SideBar() {
    return (
        <main className="text-white flex h-full flex-col px-2 py-4 md:px-2">            
            ...
            <div className="hidden Socio-icons animate-bounce md:animate-none  md:flex items-center justify-center  md:bottom-44 mt-6 md:mt-12  md:fixed  ">
