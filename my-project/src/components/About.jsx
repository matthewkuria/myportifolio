...
export default function About(){
    return(
        <section className=" grid md:grid-cols-3 gap-3 p-6 border border-blue-600 md:rounded-s-full">
          <div className="">
          <h1 className="text-2xl font-bold text-blue-600">My Bio</h1>
          <p className="text-xl">Besides being a Computer Science Graduate, I have earned my self experience as a Software Developer.</p>
          </div>
          <div className="">
